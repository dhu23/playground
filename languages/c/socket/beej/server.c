...
int main(void)
{
    int sockfd, new_fd; // listen on sock_fd, new_connection on new_fd
    ...
    for (p = servinfo; p != NULL; p = p->ai_next) {
        ...
        printf("created socket and bound successfully\n");
        break;
    }

    freeaddrinfo(servinfo); // add done with this structure

    if (p == NULL) { // finished the loop without any success case
